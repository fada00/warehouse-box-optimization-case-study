...
> **⚠️ Note:** This repository serves as a **technical case study** for a project developed during my internship. Due to company confidentiality agreements, the source code and proprietary datasets are not shared. This document details the algorithmic logic and problem-solving approach.
...
* **Naive Approach:** Opening random boxes that contain the requested items leads to many partially empty master cartons, creating clutter and increasing "handling" time.
